package heranca.herancaAbstracao;
...
public class Aluno extends Pessoa{
    ...
    public void verificarAcesso(){
        this.nomeVisivel="tá visível";
        super.nomeVisivel="tá visível";
        super.setNomeVisivel(nomeVisivel);
    }
    public Aluno(){
        super();
    }
    ...
    @Override
    public void imprmirEtiquetaEtiqueta() {
